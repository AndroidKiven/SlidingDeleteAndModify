...
public class MainActivity extends AppCompatActivity implements ItemClickListener, MyLinearLayout.OnScrollListener {
    ...
    @Override
    public void itemModifyClick(View view, int position) {
        myRecyclerViewAdapter.modifyItem("已经修改过", position);
        Toast.makeText(this, "修改" + position + "个", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void itemClick(int position) {
        Toast.makeText(this, "当前点击第" + position + "个", Toast.LENGTH_SHORT).show();
    }
